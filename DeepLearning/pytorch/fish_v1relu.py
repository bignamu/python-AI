...
# 주어진 csv 파일 읽기
fish_file = pd.read_csv('https://raw.githubusercontent.com/bignamu/python-AI/main/DeepLearning/0706_data/Fish.csv')
...
# 모듈에 가져온 데이터 넣기
# dataset & loader 설정
batch_size = 6                      # 1 -> 2 -> 3 -> 6 / 갈수록 loss 값이 작아짐(학습시키는 양이 증가되는거라 당연한 것)
